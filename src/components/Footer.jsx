...
const Footer = () => {
    return (
        <div className='min-w-full flex justify-center items-center h-16 text-xs text-[#4b5563] font-medium'>
            <div className='w-full sm:w-[40rem] md:w-[40rem] lg:w-[40rem] flex justify-between py-4 h-14 border-t border-neutral-700 sm:translate-x-2 cursor-pointer'>
                <p>© 2025 Portfolio | Satyajeet Singh.</p>
