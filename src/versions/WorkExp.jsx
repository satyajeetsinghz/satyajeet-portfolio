...
const WorkExperience = () => {
    return (
        <div className="flex min-h-fit items-start justify-center mb-8 sm:mt-2">
                ...
                <div className='mx-2'>
                    ...
                    <div className="group relative flex gap-x-5">
                        ...
                        <div className="grow pb-8 group-last:pb-0">
                            ...
                            <p className="mt-1 text-sm text-gray-600 :text-neutral-400">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed eum reprehenderit, animi repellendus ipsa praesentium est. At esse laboriosam quia autem ex error, dicta culpa vel. Quas odit modi possimus?
                            </p>

                            <div className="mt-3">
                                {/* <!-- Card --> */}
                                <a className="block border border-gray-200 rounded-lg hover:shadow-sm focus:outline-none :border-neutral-700" href="#">
                                    <div className="relative flex items-center overflow-hidden">
                                        ...
                                        <div className="grow p-4 ms-32 sm:ms-48">
                                            <div className="min-h-24 flex flex-col justify-center">
                                                <h3 className="font-semibold text-sm text-gray-800 :text-neutral-300">
                                                    Studio by Mailchimp
                                                </h3>
                                                <p className="mt-1 text-sm text-gray-500 :text-neutral-500">
                    ...
                    <div className="group relative flex gap-x-5">
                        ...
                        <div className="grow pb-8 group-last:pb-0">
                            ...
                            <p className="mt-1 text-sm text-gray-600 :text-neutral-400">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium enim cupiditate quam dolor porro, voluptatem amet! Qui, officia, amet eum autem cupiditate recusandae veritatis ducimus voluptatibus numquam illum voluptates asperiores soluta corrupti ad quas laudantium.
                            </p>
                        </div>
                        {/* <!-- End Right Content --> */}
                    </div>
                    ...
                    <div className="group relative flex gap-x-5">
                        ...
                        <div className="relative group-last:after:hidden after:absolute after:top-8 after:bottom-2 after:start-3 after:w-px after:-translate-x-[0.5px] after:bg-gray-200 :after:bg-neutral-700">
                            <div className="relative z-10 size-6 flex justify-center items-center">
                                <svg className="shrink-0 size-6 text-gray-800 :text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
